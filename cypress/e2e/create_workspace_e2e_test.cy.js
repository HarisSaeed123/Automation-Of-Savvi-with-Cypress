...
describe("Workspace end to end t                                                                                            esting", () => {
  ...
  it("A logged in user can create a workspace", () => {
    ...
    cy.contains('a', customer).should('be.visible').contains(boardIcon, 'boards').should('be.visible')
    cy.contains('a', customer).should('be.visible').contains(usersIcon, 'users').should('be.visible')
    cy.contains('a', customer).should('be.visible').contains(activityIcon, 'activity').should('be.visible')
